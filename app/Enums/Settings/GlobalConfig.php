...
enum GlobalConfig
{
    ...
    const STATES = [
        ...
        ['name' => 'Île-de-France', 'country_code' => 'FR'],
        ['name' => 'Provence-Alpes-Côte d\'Azur', 'country_code' => 'FR'],
        ...
        ['name' => 'Catalonia', 'country_code' => 'ES'],
