...
class WithdrawController extends Controller
{
    ...
    public function withdrawLogCsv(): \Symfony\Component\HttpFoundation\StreamedResponse{
        $fileHeaders = ['TIME','USER','SELLER','DELIVERYMAN','METHOD','AMOUNT','CHARGE' , 'RECEIVABLE' ];
        $pluckableKeys = ['created_at', ['user' , 'email'],['seller' , 'email'],['deliveryman' , 'email'], ['method' , 'name'] ,'amount' , 'charge', 'final_amount' ];


        return $this->csvExport( 'Withdraw',  'deposit_log', $fileHeaders ,  $pluckableKeys);
    }
