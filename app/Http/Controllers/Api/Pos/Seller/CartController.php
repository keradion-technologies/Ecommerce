...
class CartController extends Controller
{
    ...
    {
        $response = $this->cartService->addToCart($request, auth()->guard('seller:api')->user());
    ...
    {
        $response = $this->cartService->updateCart($request, auth()->guard('seller:api')->user());
    ...
    {
        $cartItems = $this->cartService->getCartItems(auth()->guard('seller:api')->user());
    ...
    {
        $response = $this->cartService->removeFromCart($cartId, auth()->guard('seller:api')->user());
    ...
    {
        $response = $this->cartService->holdCart(auth()->guard('seller:api')->user());
    ...
    {
        $response = $this->cartService->restoreCart($holdUid, auth()->guard('seller:api')->user());
    ...
    {
        $response = $this->cartService->getHoldList(auth()->guard('seller:api')->user());
