...
class Product extends Model
{
    ...
    public function scopeInhouseProduct(Builder $query)
    {
    ...
    public function scopeSellerProduct(Builder $query)
    {
    ...
    {
        (int) $categoryId = request()->input('category_id');
        (int) $brandId    = request()->input('brand_id');
        ...
        return $q
            ...
            ->when($brandId, function ($q, $brandId) {
