                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div>
                                        ...
                                        <input type="number" value="0" class="form-control" name="maximum_purchase_qty"
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div>
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="sku" id="sku" value="{{old('sku') }}" placeholder="{{translate('Product SKU')}}" required>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="barcode" id="barcode"
                                            value="{{old('barcode')}}" placeholder="{{translate('Product Barcode')}}">
                                    </div>
                                </div>
