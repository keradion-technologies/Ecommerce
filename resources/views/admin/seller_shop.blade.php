                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                ...
                                <div class="text-end">
                                    <h4 class="fs-22 fw-bold ff-secondary mb-2">
                                        <span
                                            class="counter-value">{{(short_amount($withdrawAmount))}}
                                        </span>
                                    </h4>
                                    ...
                                    <tbody>
                                        @forelse($bestSellers as $bestSeller)
                                            <tr>
                                                ...
                                                <td data-label="{{translate('Username')}}">{{($bestSeller->username ?? '-')}}</td>
                                                <td data-label="{{translate('Phone')}}">{{($bestSeller->phone ? $bestSeller->phone  : '-' )}}</td>
                                                <td data-label="{{translate('Email')}}">{{($bestSeller->email ? $bestSeller->email : '-')}}</td>
