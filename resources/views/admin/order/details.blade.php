                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0 vstack gap-3">
                                ...
                                <li>
                                    ...
                                    <span
                                        class="text-break">{{ @$phone ?? 'N/A'}}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <form action="{{ route('admin.order.assign') }}" method="POST">
                    ...
                    <div id="deliveryman-assign">
                        ...
                        <div class="mb-3"
                            ...
                            <input @if($order->status  == App\Models\Order::DELIVERED) readonly @endif   value="{{num_format(@$deliveryData->amount,site_settings("digit_after_decimal",2))}}" type="number"
