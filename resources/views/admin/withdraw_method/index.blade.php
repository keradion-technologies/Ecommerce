					...
					<table class="table table-hover table-centered align-middle table-nowrap mb-0">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span>
									1 {{default_currency()->name}} = {{num_format(($withdrawMethod->rate))}} {{@$withdrawMethod->currency->name}}</span>
								</td>

								<td>
									{{num_format(($withdrawMethod->fixed_charge))}} + {{num_format(($withdrawMethod->percent_charge))}} %
								</td>

								<td>
									<span class="rounded p-2 badge-soft-info">{{num_format(($withdrawMethod->min_limit))}} - {{num_format(($withdrawMethod->max_limit))}} {{(default_currency()->name)}}</span>
								</td>
