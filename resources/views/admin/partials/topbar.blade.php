<header id="header">
    <div class="header-layout">
        <div class="header-navbar">
            <div class="d-flex align-items-center">
                <div class="brand-logo horizontal-logo">
                    <a href="{{route('admin.dashboard')}}" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ show_image(file_path()['admin_site_logo']['path'] . '/' . site_settings('admin_logo_sm'), file_path()['loder_logo']['size']) }}"
                                alt="{{site_settings('admin_logo_sm')}}">
                        </span>

                        <span class="logo-lg">
                            <img src="{{ show_image(file_path()['admin_site_logo']['path'] . '/' . site_settings('admin_logo_lg'), file_path()['admin_site_logo']['size']) }}"
                ...
                <div class="header-action-btn d-flex align-items-center me-md-2 me-xl-3">
                    ...
                    <div class="dropdown card-header-dropdown d-none d-sm-block">
                        ...
                        <button data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="{{translate('Add New')}}"
                    ...
                    <a data-bs-toggle="tooltip" data-bs-placement="top" title="{{translate('Clear Cache')}}"
                        href='{{route("admin.general.setting.cache.clear")}}'
                        class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle waves ripple-dark">
                        <i class='bx bx-brush fs-22'></i>
                    </a>

                    <a target="_blank" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="{{translate('Browse Frontend')}}" href="{{route('home')}}"
                        class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle waves ripple-dark">
            ...
            <div class="d-flex align-items-center">
                <div class="dropdown card-header-dropdown header-item ms-1">
                    <a class="btn btn-icon topbar-btn btn-ghost-secondary rounded-circle lang-btn waves ripple-dark"
                        href="{{ route('admin.pos.system.index') }}">
                ...
                <div class="dropdown card-header-dropdown header-item ms-1">
                    <button @if(count($currencys) != 0) data-bs-toggle="dropdown" aria-haspopup="true"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        @foreach($currencys as $currency)
                            <a class="dropdown-item chanage_currency" data-value="{{$currency->id}}"
                ...
                <div class="dropdown topbar-head-dropdown header-item ms-1">
                    ...
                    @endphp
                    <button type="button"
                        class="dropdown-toggle btn btn-icon topbar-btn btn-ghost-secondary rounded-circle lang-btn waves ripple-dark"
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            @foreach($languages as $language)
                                <a href="{{route('language.change', $language->code)}}"
                                    class="dropdown-item notify-item language py-2" data-lang="{{$language->code}}"
                                    title="{{$language->name}}">
                ...
                <div class="dropdown topbar-head-dropdown ms-sm-1 header-item" id="notificationDropdown">
                    <a title="{{translate('Placed Order')}}" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        @if($physical_product_order_count > 0)
                            <span class="position-absolute topbar-badge  translate-middle badge rounded-pill bg-danger">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="{{show_image(file_path()['profile']['admin']['path'] . '/' . auth_user()->image, file_path()['profile']['admin']['size'])}}"
                                alt="{{auth_user()->image}}">
