		...
		<div class="card">
			...
			<div class="card-header border-0">
				<div class="row g-4 align-items-center">
					...
					@if(request()->routeIs('admin.gateway.payment.pos.*'))
						<div class="col-sm-auto">
							<div class="d-flex flex-wrap align-items-start gap-2">
								<a href="{{route('admin.gateway.payment.pos.method.create')}}" class="btn btn-success btn-sm w-100 waves ripple-light"> <i
											class="ri-add-line me-1 align-bottom"></i>
										{{translate('Create')}}
									</a>
							</div>
			...
			<div class="card-body px-0 pt-0">
				...
				<ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
					...
					<li class="nav-item">
                        <a class="nav-link {{request()->routeIs('admin.gateway.payment.pos.method') ? 'active' :'' }}  Manual py-3"  id="pos"
                            href="{{route('admin.gateway.payment.pos.method')}}" >

							<i class="ri-money-dollar-box-line me-1 align-bottom"></i>
                            {{translate('Pos Payment methods')}}
