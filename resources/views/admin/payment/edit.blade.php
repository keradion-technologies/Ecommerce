            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item">
						<a href="{{ $paymentMethod->type === App\Models\PaymentMethod::MANUAL 
								? route('admin.gateway.payment.manual.method') 
								: ($paymentMethod->type === App\Models\PaymentMethod::POS 
									? route('admin.gateway.payment.pos.method') 
									: route('admin.gateway.payment.method')) 
						}}">
             ...
             <div class="card-body">
                <form action="{{route('admin.gateway.payment.update', $paymentMethod->id)}}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
						...
						@if(!in_array($paymentMethod->type, [App\Models\PaymentMethod::MANUAL, App\Models\PaymentMethod::POS]))
						...
						<div class="col-lg-6">
							...
							<div class="input-group">
								  <input type="text" class="form-control" id="percent_charge" name="percent_charge" value="{{num_format($paymentMethod->percent_charge)}}" placeholder="{{translate('Enter number')}}" >
						...
						<div class="col-lg-6">
							...
							<div class="input-group mb-3">
								  ...
								  <input type="text" name="rate" value="{{num_format($paymentMethod->rate)}}" class="form-control" aria-label="Amount (to the nearest dollar)">
