                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-8 d-flex align-items-end justify-content-end">
                        <div class="d-flex flex-wrap  align-items-end justify-content-end  gap-2">
                            ...
                            <a href="{{route('admin.customer.deposit.export.csv')}}" class="btn btn-info btn-sm  waves ripple-light"> <i
                            ...
                            <div class="search-box">
                                  <select name="user_id" id="userId">
                                      ...
                                      @foreach ($customers as $customer)
                                         ...
                                         <option {{ $customer->id == request()->input('user_id') ? 'selected' :''  }} value="{{$customer->id}}">
