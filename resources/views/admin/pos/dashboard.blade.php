                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="{{route('admin.report.seller.transaction')}}" class="d-flex align-items-center justify-content-end gap-1">
                                        {{translate('View All')}}
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                ...
                                <div class="text-end">
                                    ...
                                    <p class="text-uppercase fw-medium text-muted mb-3">
                                        {{translate("POS Order Payment")}}
                                    </p>

                                    <a href="{{route('admin.pos.system.inhouse.order.index')}}" class="d-flex align-items-center justify-content-end gap-1">
                                        {{translate('View All')}}
                                         <i class="ri-arrow-right-line"></i>
                                    </a>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                ...
                                <div class="text-end">
                                    ...
                                    <p class="text-uppercase fw-medium text-muted mb-3">
                                        {{translate('Delivered POS Orders')}}
                                    </p>

                                    <a href="{{route('admin.pos.system.inhouse.order.delivered')}}" class="d-flex align-items-center justify-content-end gap-1">
                                        {{translate('View All')}}
                                         <i class="ri-arrow-right-line"></i>
                                    </a>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                ...
                                <div class="text-end">
                                    ...
                                    <p class="text-uppercase fw-medium text-muted mb-3">
                                        {{translate('Shipped POS Orders')}}
                                    </p>

                                    <a href="{{route('admin.pos.system.inhouse.order.shipped')}}" class="d-flex align-items-center justify-content-end gap-1">
                                        {{translate('View All')}}
                                         <i class="ri-arrow-right-line"></i>
                                    </a>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                ...
                                <div class="text-end">
                                    ...
                                    <p class="text-uppercase fw-medium text-muted mb-3">
                                         {{translate('Canceld POS Orders')}}
                                    </p>

                                    <a href="{{route('admin.pos.system.inhouse.order.cancel')}}" class="d-flex align-items-center justify-content-end gap-1">
                                        {{translate('View All')}}
                                         <i class="ri-arrow-right-line"></i>
                                    </a>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="{{translate('Customer')}}" class="text-align-left">
                                                    ...
                                                    @else
                                                         ...
                                                         {{@$order->billingAddress ? @$order->billingAddress->email :  @$order->billing_information->email ?? '-'}}
                                                    @endif
                                        ...
                                        @forelse(Arr::get($data,'best_selling_product') as $inhouseProduct)
                                            <tr>
                                                ...
                                                <td data-label="{{translate('Info')}}">
                                                    <span>{{translate('Regular Price')}} : {{(short_amount($inhouseProduct->price))}} <br> {{translate('Discount Price')}} : {{(short_amount($inhouseProduct->discount))}}</span>
                            ...
                            <div class="row g-0 text-center">
                                ...
                                <div class="col-4 col-sm-4">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1"><span>{{Arr::get($data,'pos_order',0) + Arr::get($data,'digital_order',0)  }}</span></h5>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-height-100">
                        <div class="card-header border-bottom-dashed align-items-center d-flex mb-2">
                            <h4 class="card-title mb-0 flex-grow-1">
                                {{translate('Store Visitors Insight')}}
                            </h4>

                            
                            <a href="{{route('admin.security.ip.list')}}" class="d-flex align-items-center justify-content-end gap-1">
                                {{translate('View All')}}
                                 <i class="ri-arrow-right-line"></i>
                            </a>
...
$posArray       = array_column($ordersArr , 'pos');
$webArray       = array_column($ordersArr , 'web');
...
$posSell                    = array_values($data['product_sell_by_month_pos']);
...
<script type="text/javascript">
   "use strict";
    ...
    var options = {
        ...
        {
            name: "{{ translate('Pos Order') }}",
            data: @json($posArray),
        },
        {
            name: "{{ translate('Web Order') }}",
            data: @json($webArray),
        },
        ],
        xaxis: {
    ...
    var options = {
        ...
        series: [
        {
            name: "{{ translate('Pos Order Payment') }}",
            data: payment,
        },
        {
