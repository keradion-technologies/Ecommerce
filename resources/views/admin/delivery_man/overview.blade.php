                                                    ...
                                                    <tbody class="list form-check-all">
                                                        @forelse($overview['withdraw']['log'] as $withdraw)
                                                            <tr>
                                                                ...
                                                                <td data-label="{{ translate('Amount') }}">
                                                                    {{ num_format($withdraw->amount) }}
                                                                    {{ default_currency()->name }}

                                                                </td>

                                                                <td data-label="{{ translate('Charge') }}">
                                                                    {{ num_format($withdraw->charge) }}
                                                                    {{ default_currency()->name }}
                                                                </td>

                                                                <td data-label="{{ translate('Receivable') }}">
                                                                    <span
                                                                        class="text-success">{{ num_format($withdraw->final_amount) }}
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td data-label="{{ translate('Amount') }}">
                                                                    <span
                                                                        ...
                                                                        {{ $transaction->transaction_type == '+' ? '+' : '-' }}{{ num_format($transaction->amount) }}
                                                                        {{ default_currency()->name }}</span>

                                                                </td>
                                                                <td data-label="{{ translate('Post Balance') }}">
                                                                    <span
                                                                        class="fw-bold text-primary">{{ num_format($transaction->post_balance) }}
                                                                        {{ default_currency()->name }}</span>
                                                                </td>
