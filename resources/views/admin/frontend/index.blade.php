																	...
																	<tbody class="list form-check-all">
																		@foreach(@json_decode($frontend->value,true) ?? [] as $key => $data)
																		    ...
																		    <tr>
																				...
																				<td data-label='{{$key}}'>
																					<input required  name="frontend[{{$key}}][heading]" type="text"  value="{{Arr::get($data ,'heading', '-')}}" class="form-control file-input">
																				</td>
																				<td data-label='{{$key}}'>

																					<input required  name="frontend[{{$key}}][sub_heading]" type="text"  value="{{Arr::get($data ,'sub_heading', '-')}}" class="form-control file-input">
																				</td>
																				<td data-label='{{$key}}'>

																					<input required  name="frontend[{{$key}}][icon]" type="text"  value="{{Arr::get($data ,'icon', '-')}}" class="form-control file-input">
																				</td>
