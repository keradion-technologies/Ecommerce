                                ...
                                <div class="col-xl-4">
                                    <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item d-flex align-items-center justify-content-between gap-3 flex-wrap">
                                                ...
                                                <span>1 {{default_currency()->name}} = {{num_format(($withdraw->rate))}} {{($withdraw->currency->name)}}</span>
                                            </li>
                                            <li class="list-group-item d-flex align-items-center justify-content-between gap-3 flex-wrap">
                                                        ...
                                                        <div class="pt-3">
                                                            <ul class="list-unstyled vstack gap-3 mb-0">
                                                                <li class="list-group-item d-flex justify-content-between align-items-start flex-wrap gap-2 px-2 fs-14">
                                                                    ...
                                                                    <span>{{num_format(($method->min_limit))}} - {{num_format(($method->max_limit))}} {{(default_currency()->name)}}</span>
                                                                </li>

                                                                <li class="list-group-item d-flex justify-content-between align-items-start flex-wrap gap-2 px-2 fs-14">
                                                                    <div class="me-auto">{{translate('Charge')}}</div>
                                                                    <span>{{num_format(($method->fixed_charge))}} {{(default_currency()->name)}} + {{num_format(($method->percent_charge))}} %</span>
                                                                </li>
