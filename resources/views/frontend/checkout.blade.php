                                                    ...
                                                    <div class="col-md-4">
                                                        <div>
                                                            ...
                                                            <input class="form-control user-info" type="text"
                                                                ...
                                                                placeholder="{{ translate('1205') }}" >
                                                        </div>
                                                    </div>

                                                </div>
                                                @if(site_settings('gmap_status') ==  App\Enums\StatusEnum::true->status())
                                    ...
                                    <div class="row g-4">
                                        <div class="col-xl-6">
                                            <div>
                                                ...
                                                <input type="text" name="latitude" id="add-billinginfo-latitude"
                                                    class="form-control latitude" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div>
                                                ...
                                                <input type="text" name="longitude" id="add-billinginfo-longitude"
                                                    class="form-control longitude" value="">
                                            </div>
                                        </div>
