                    ...
                    <div class="product-item">
                        <div class="product-img">
                            ...
                            <span class="offer-tag">{{translate('off')}} @if($product->pivot->discount_type == 0)
                                {{show_currency()}}@else%@endif{{num_format(($product->pivot->discount))}}
                            </span>
                         ...
                         <div class="product-info">
                                ...
                                <div class="priceAndRatting">
                                        ...
                                        <div class="product-price">
                                            @include('frontend.partials.product_price',['product' => $product , "campain_details" => true])
                                        </div>

                                </div>

                                @include('frontend.partials.product_action',['product' => $product ,'rand_separator'=> true ,'rand_separator_text' => $campaign->slug , 'campaign' => $campaign  ])
