<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-12">
      <section class="mt-1" id='DivIdToPrint' style="
                  width: 970px;
                  height: fit-content;
                  padding: 50px 0;
        ...
        <div style="
                  ...
                  ">
          <img
            src="{{ show_image(file_path()['site_logo']['path'] . "/" . site_settings('admin_logo_lg'), file_path()['admin_site_logo']['size']) }}"
            alt="{{site_settings('admin_logo_lg')}}" style="width: 140px; height: 40px" />
        </div>
        <div style="
                    width: 100%;
                    height: 40px;
        ...
        @endphp
          ...
          <div>
            <p
              ...
              {{translate('Invoice')}}#
              <span style="font-size: 14px; padding-left: 30px; color: #333">{{$order->order_id}}</span>
            </p>
            ...
            <p
              ...
              {{translate('Date')}}
              <span
                style="font-size: 14px; padding-left: 30px; color: #333">{{get_date_time($order->created_at, 'd-m-Y')}}</span>
            </p>
      ...
      <div style="padding: 0 30px">
        <h1 style=" font-size: 16px; font-weight: 600; text-align: center;margin: 20px;">
    ...
    @endif
      ...
      @endphp
            ...
            $totalAmount += $orderDetail->original_price / $orderDetail->quantity * $orderDetail->quantity;
          @endphp
        @endforeach
              <tr style="border: 1px solid #dddddd; border-style:solid !important;">
        ...
        @endphp
          ...
          <img src="{{ asset('assets/images/backend/invoiceLogo/' . $invoiceLogos['Delivered']) }}"
          alt="delivered.jpg" style="width: 100px; margin-left: 50px" />
        @endif
        @elseif($order->payment_status == 2)
          @if($invoiceLogos['paid'])
          <img src="{{ asset('assets/images/backend/invoiceLogo/' . $invoiceLogos['paid']) }}" alt="paid.jpg"
          style="width: 100px; margin-left: 50px" />
        @endif
        @elseif($order->payment_status == 1)
          @if($invoiceLogos['unpaid'])
          <img src="{{ asset('assets/images/backend/invoiceLogo/' . $invoiceLogos['unpaid']) }}" alt="unpaid.jpg"
          style="width: 100px; margin-left: 50px" />
        @endif
        @endif
        @else
            @if($invoiceLogos['Cash On Delivery'])
          <img src="{{ asset('assets/images/backend/invoiceLogo/' . $invoiceLogos['Cash On Delivery']) }}"
          alt="cod.jpg" style="width: 100px; margin-left: 50px" />
        @endif
        @endif
          ...
          <div style="width: 50%;">
            <div style="
              ...
              <p style="
                ...
                <small
                  style="padding-left: 30px; color: #333; font-size: 14px">{{(short_amount($originalPrice))}}</small>
              </p>
              ...
              <p style="
                ...
                {{translate('Discount')}}:
                <small
                  style="padding-left: 30px; color: #333; font-size: 14px">{{(short_amount($order->discount))}}</small>
              </p>
              ...
              <p style="
                ...
                <small
                  style="padding-left: 30px; color: #333; font-size: 14px">{{(short_amount($order->shipping_charge))}}</small>
              </p>
              ...
              <p style="
                                ...
                                ">
                {{translate('Total')}}:
                <small style="font-weight: 700; padding-left: 30px">{{(short_amount($order->amount))}}</small>
              </p>
            </div>
          </div>
        </div>
