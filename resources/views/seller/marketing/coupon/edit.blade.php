	...
	<div class="container-fluid">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('seller.marketing.coupon.index')}}">
                        {{translate('Coupons')}}
                    </a></li>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
             ...
             <div class="card-body">
				<form action="{{route('seller.marketing.coupon.update', $coupon->id)}}" method="POST" enctype="multipart/form-data">
					@csrf
                    <div class="row g-3">
						<div class="col-lg-6">
						...
						<div class="col-lg-6">
							...
							<input  value="{{num_format(($coupon->value))}}"  type="text" name="value" id="value" value="{{old('value')}}" class="form-control" placeholder="{{translate('Enter coupon value')}}" required>
						</div>
