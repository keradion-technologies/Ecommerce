                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex flex-wrap align-items-start gap-2">
                            <a href="{{route('seller.marketing.coupon.create')}}" class="btn btn-success btn-sm add-btn waves ripple-light">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hstack justify-content-center gap-3">
                                        <a class="fs-18 link-warning" title="{{translate('Update')}}" data-bs-toggle="tooltip" data-bs-placement="top" href="{{route('seller.marketing.coupon.edit', $coupon->id)}}"><i class="ri-pencil-line"></i></a>
...
<div class="modal fade" id="coupondelete" tabindex="-1" aria-labelledby="coupondelete" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{route('seller.marketing.coupon.delete')}}" method="post">
				@csrf
