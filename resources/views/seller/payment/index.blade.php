		...
		<div class="card">
			...
			<div class="card-header border-0">
				<div class="row g-4 align-items-center">
					<div class="col-sm">
						<div>
							<h5 class="card-title mb-0">
								{{translate('Pos Payment Method List')}}
							</h5>
						</div>
					</div>
					...
					@if(request()->routeIs('seller.gateway.payment.pos.*'))
						<div class="col-sm-auto">
							<div class="d-flex flex-wrap align-items-start gap-2">
								<a href="{{route('seller.gateway.payment.pos.method.create')}}" class="btn btn-success btn-sm w-100 waves ripple-light"> <i
									...
									<td>
										<div class="hstack justify-content-center gap-3">
											@if(permission_check('update_method'))
												<a title="{{translate('Update')}}" data-bs-toggle="tooltip" data-bs-placement="top" href="{{route('seller.gateway.payment.edit', [make_slug($paymentMethod->name), $paymentMethod->id])}}" class="pointer fs-19 link-warning">
													<i class="ri-pencil-fill"></i>
												</a>
											@endif

											@if(permission_check('delete_method') && ($paymentMethod->type == App\Models\PaymentMethod::MANUAL ||$paymentMethod->type == App\Models\PaymentMethod::POS))
												<a  title="{{translate('Delete')}}" data-bs-toggle="tooltip" data-bs-placement="top" href="javascript:void(0);" data-href="{{route('seller.gateway.payment.delete',$paymentMethod->id)}}" class="delete-item fs-18 link-danger">
...
@include('seller.modal.delete_modal')
@endsection
