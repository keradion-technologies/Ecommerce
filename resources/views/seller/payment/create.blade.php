...
<div class="page-content">
	<div class="container-fluid">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('seller.gateway.payment.pos.method')}}">
        ...
        <div class="card">
			...
			<div class="card-body">
				<form class="overflow-hidden" action="{{ 
										request()->routeIs('seller.gateway.payment.pos.*') 
											? route('seller.gateway.payment.pos.method.store') 
											: route('seller.gateway.payment.manual.method.store') 
									}}"
									method="POST"
