	...
	<div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
             ...
             <div class="card-body">
                <form action="{{route('seller.gateway.payment.update', $paymentMethod->id)}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-3">
						...
						@if($paymentMethod->type == App\Models\PaymentMethod::POS)
							<div class="col-12">
