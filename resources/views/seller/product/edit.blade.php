                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            ...
                                            <input  step="any" type="number" class="form-control" id="price" name="price"
                                                value="{{num_format($product->price,site_settings('digit_after_decimal',2))}}" placeholder="{{translate('Product price')}}">
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            ...
                                            value="{{num_format($product->discount_percentage)}}"
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div>
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="sku" id="sku" value="{{$product->sku}}" placeholder="{{translate('Product SKU')}}" required>
                                                <button type="button" class="btn btn-primary" id="generate_sku">{{translate('Generate SKU')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="barcode" id="barcode"
                                                value="{{$product->barcode}}" placeholder="{{translate('Product Barcode')}}">
                                        </div>  
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                id="warranty_policy" placeholder="{{translate('Enter warranty policy')}}" >{{$product->warranty_policy}}</textarea>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input step="any" type="number" class="form-control" id="weight" name="weight"
                                     value="{{num_format($product->weight)}}" placeholder="{{translate('Product Weight')}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id='shipping_delivery_id' class="form-select select2"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input step="any" placeholder="{{translate("Enter shipping fees")}}"  name="shipping_fee" id="shipping_fee" type="number" class="form-control"  value="{{num_format($product->shipping_fee,site_settings('digit_after_decimal',2))}}"
                                        required>
...
<script>
    ...
    $("#generate_sku").on("click", function () {
        const prefix = "{{ site_settings('sku_prefix') }}" || "SKU";
