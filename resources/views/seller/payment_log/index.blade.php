        ...
        <div class="card" id="orderList">
            ...
            <div class="card-body pt-0">
                <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('seller.payment.logs') ? 'active' :'' }} All py-3"  id="All"
                            href="{{route('seller.payment.logs')}}" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('seller.payment.pending') ? 'active' :''}}   py-3"  id="Placed"
                            href="{{route('seller.payment.pending')}}" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{request()->routeIs('seller.payment.approved') ? 'active' :''}} Confirmed py-3"  id="Confirmed"
                            href="{{route('seller.payment.approved')}}" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link Processing {{request()->routeIs('seller.payment.rejected') ? 'active' :''}}   py-3"  id="Processing"
                            href="{{route('seller.payment.rejected')}}" >
                            ...
                            @forelse($paymentLogs as $paymentLog)
                                    <tr>
                                        ...
                                        <td data-label="{{translate('Final Amount')}}">
                                            {{num_format(($paymentLog->final_amount))}} {{@$paymentLog->paymentGateway->currency->name ?? default_currency()->name}}
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td class="border-bottom-0" colspan="100">
                                            @include('seller.partials.not_found')
                                        </td>
                                    </tr>
                            @endforelse
                        </tbody>
