											...
											<div class="pt-3">
												<ul class="list-unstyled vstack gap-2 mb-0">
													<li class="list-group-item d-flex justify-content-between align-items-start flex-wrap gap-2 px-2">
														...
														<span>{{num_format(($withdrawMethod->min_limit))}} - {{num_format(($withdrawMethod->max_limit))}} {{(default_currency()->name)}}</span>
													</li>
													<li class="list-group-item d-flex justify-content-between align-items-start flex-wrap gap-2 px-2">
														<div class="me-auto">{{translate('Charge')}}</div>
														<span>{{num_format(($withdrawMethod->fixed_charge))}} {{(default_currency()->name)}} + {{num_format(($withdrawMethod->percent_charge))}} %</span>
													</li>
													<li class="list-group-item d-flex justify-content-between align-items-start flex-wrap gap-2 px-2">
