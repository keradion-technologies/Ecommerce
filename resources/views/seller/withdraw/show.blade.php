        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('seller.withdraw.history')}}">
                        {{translate("Logs")}}
                    </a></li>
                            ...
                            <div>
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                        {{translate('Amount')}}
                                        <span class="font-weight-bold">{{num_format($withdraw->amount)}} {{default_currency()->name}}</span>
                                    </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                        {{translate('Charge')}}
                                        <span class="font-weight-bold">{{num_format($withdraw->charge)}} {{default_currency()->name}}</span>
                                    </li>

                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        {{translate('Receivable')}}
                                        <span class="font-weight-bold">{{num_format($withdraw->final_amount)}} {{@$withdraw->currency->name}}</span>
                                    </li>
