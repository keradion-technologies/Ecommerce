                                ...
                                <div class="d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="text-end">
                                        <h4 class="fs-22 fw-bold ff-secondary mb-2">
                                            {{short_amount($seller->pos_balance)}}
                                        </h4>


                                        <p class="text-uppercase fw-medium text-muted mb-3">
                                            {{translate("Total Pos Balance")}}
                                        </p>

                                        <a href="{{route('seller.transaction.history.pos')}}"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <p class="text-uppercase fw-medium text-muted mb-3">
                                            {{translate('Placed POS Orders')}}
                                        </p>

                                        <a href="{{route('seller.pos.system.order.placed')}}"
                                            class="d-flex align-items-center justify-content-end gap-1">
                                            {{translate('View All')}}
                                            <i class="ri-arrow-right-line"></i>
                                        </a>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="{{route('seller.pos.system.order.delivered')}}"
                                            class="d-flex align-items-center justify-content-end gap-1">
                                            {{translate('View All')}}
                                            <i class="ri-arrow-right-line"></i>
                                        </a>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="{{route('seller.pos.system.order.shipped')}}"
                                            class="d-flex align-items-center justify-content-end gap-1">
                                            {{translate('View All')}}
                                            <i class="ri-arrow-right-line"></i>
                                        </a>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <p class="text-uppercase fw-medium text-muted mb-3">
                                            {{translate('Canceled POS Orders')}}
                                        </p>

                                        <a href="{{route('seller.pos.system.order.cancel')}}"
                                            class="d-flex align-items-center justify-content-end gap-1">
                                            {{translate('View All')}}
                                            <i class="ri-arrow-right-line"></i>
                                        </a>
                                    ...
                                    <table class="table table-hover table-centered align-middle table-nowrap">
                                        <thead class="text-muted table-light">
                                            <tr>
                                                ...
                                                <th>{{translate('Post Pos Balance')}}</th>
                                            ...
                                            @forelse($transactions as $transaction)
                                                <tr>
                                                    ...
                                                    <td data-label="{{translate('Post Balance')}}">
                                                        <span class="fw-bold">{{(short_amount($transaction->post_balance_pos))}}
                                                        </span>
                                                    </td>
    ...
    <script type="text/javascript">
        ...
        if (chartDonutBasicColors) {
            var options = {
                ...
                labels: ["All", "placed", "confirmed", "processing", "shipped", "delivered", "cancel"],
