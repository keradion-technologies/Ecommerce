    ...
    <div class="page-content">
        <div class="container-fluid">
                ...
                @php
                    ...
                    $routePrefix = $isPOS ? 'seller.pos.system.order.' : 'seller.order.';
                    $navItems = [
                        ['key' => 'index', 'label' => 'All Orders', 'icon' => 'ri-luggage-cart-line'],
                        ['key' => 'pending', 'label' => 'Pending Orders', 'icon' => 'ri-pause-circle-line'],
                        ['key' => 'placed', 'label' => 'Placed Orders', 'icon' => 'ri-map-pin-line'],
                        ['key' => 'confirmed', 'label' => 'Confirmed Order', 'icon' => 'ri-checkbox-multiple-fill'],
                        ['key' => 'processing', 'label' => 'Processing', 'icon' => 'ri-refresh-line'],
                        ['key' => 'shipped', 'label' => 'Shipped', 'icon' => 'ri-ship-line'],
                        ['key' => 'delivered', 'label' => 'Delivered', 'icon' => 'ri-checkbox-circle-line'],
                        ['key' => 'cancel', 'label' => 'Canceled Order', 'icon' => 'ri-close-circle-line'],
                        ['key' => 'return', 'label' => 'Return Order', 'icon' => 'ri-text-wrap'],
                    ];
                @endphp

            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">
                    {{ translate($isPOS ? 'POS Orders' : 'Inhouse Order') }}
                </h4>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <h5 class="card-title mb-0">
                                {{ translate($isPOS ? 'Pos Orders List' : 'Orders List') }}
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body pt-0">
                    <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                        @foreach ($navItems as $item)
                            <li class="nav-item">
                                <a class="nav-link py-3 {{ request()->routeIs($routePrefix . $item['key']) ? 'active' : '' }}"
                                    id="{{ ucfirst($item['key']) }}" href="{{ route($routePrefix . $item['key']) }}">
                                    <i class="{{ $item['icon'] }} me-1 align-bottom"></i>
                                ...
                                @forelse($orders as $order)
                                    <tr>
                                        ...
                                        <td data-label="{{ translate('Order Number') }}">
                                            ...
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Order Number"
                                        ...
                                        <td data-label="{{ translate('Customer Info') }}" class="text-align-left">
                                            ...
                                            <span>
                                                {{ translate('Email') }}
                                                :
                                                {{ @$order->customer->email ?? @$email }}</span>
                                            <br>
                                        ...
                                        <td data-label="{{ translate('Amount') }}">
                                            ...
                                            @endphp
                                            <span class="fw-bold">
                                                {{ short_amount($totalAmount) }}</span><br>
                                        ...
                                        <td data-label="{{ translate('Action') }}">
                                            ...
                                            <div class="hstack justify-content-center gap-3">
                                                <a title="Print" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    href="{{ route('seller.order.print', [$order->id]) }}"
