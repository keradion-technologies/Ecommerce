...
Route::middleware($globalMiddleware)->group(function () {
    ...
    Route::prefix('seller')->name('seller.')->group(function () {
        ...
        Route::middleware(['seller', 'checkSellerStatus', 'seller.kyc'])->group(function () {
            ...
            Route::get('transaction/log/pos', [HomeController::class, 'posTransaction'])->name('transaction.history.pos');
            ...
            #POS_SYSTEM
            Route::group(['middleware' => ['module:pos,seller']], function () {
                ...
                Route::controller(PosController::class)->prefix('/pos')->name('pos.system.')->group(function () {
                    ...
                    Route::get('hold/catr/list', 'holdCartList')->name('hold.cart.list');
            ...
            #Payment Log Route
            Route::controller(PaymentMethodController::class)->name('payment.')->prefix('/payment')->group(function () {
                Route::get('/logs', 'logs')->name('logs');
                Route::get('/pending/logs', 'logs')->name('pending');
                Route::get('/approved/logs', 'logs')->name('approved');
                Route::get('/rejected/logs', 'logs')->name('rejected');
